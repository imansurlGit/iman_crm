...
// Vue projet du développeur : contexte du projet + ses propres tâches de
// prestation dessus (le seul poste de travail réel côté développeur — voir
// DeveloppeurWorkspaceContext.tsx). Volontairement distincte de
// ProjetDetailPage.tsx, qui bascule vers le poste de travail du chef de
// division dès qu'une prestation appartient à sa division : un développeur
// appartient à la même division que le CDN et se retrouverait sinon avec des
// contrôles de réaffectation/suppression qui ne lui reviennent pas.
...
export default function DeveloppeurProjetDetailPage() {
  const { id } = useParams();
  const navigate = useNavigate();
  const { tasks } = useDeveloppeurWorkspace();
  ...
  return (
    <div className="flex flex-col gap-gutter">
      <button
        ...
        onClick={() => navigate('/developpeur/projets')}
        type="button"
      >
