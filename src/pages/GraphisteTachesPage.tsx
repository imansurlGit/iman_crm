...
export default function GraphisteTachesPage() {
  const navigate = useNavigate();
  const { tasks, projects, isLoading } = useGraphisteWorkspace();
  ...
  return (
    <div className="flex flex-col gap-gutter">
      <section>
        ...
        <p className="text-secondary mt-1 text-sm">Les tâches qui vous incombent, tous projets confondus.</p>
      </section>
