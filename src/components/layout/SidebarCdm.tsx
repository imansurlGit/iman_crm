...
interface CdmNavItem {
  label: string;
  to: string;
  icon: string;
}

interface CdmNavSection {
  label?: string;
  items: CdmNavItem[];
}

// Menu dédié au rôle CDM (Chef Division Marketing) — même traitement compact
// que SidebarDg.tsx / SidebarCdv.tsx / SidebarAdch.tsx.
const NAV_SECTIONS: CdmNavSection[] = [
  {
...
export default function SidebarCdm() {
  return (
      ...
      <div className="relative flex flex-col h-full">
        <div className="flex items-center gap-2.5 px-4 h-16 border-b border-white/10 shrink-0">
          ...
          <div className="flex flex-col leading-tight min-w-0">
            ...
            <span className="font-label-md text-[8px] text-white/40 uppercase tracking-widest">Division Marketing</span>
          </div>
        </div>
